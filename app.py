...
df = pd.read_csv("https://raw.githubusercontent.com/Santiago956/alura_imersao_python/refs/heads/main/dados-imersao-final.csv")
...
with col_graf4:
    if not df_filtrado.empty:
        ...
        media_salarial_ds = df_data_scientist.groupby('iso_alpha')['usd'].mean().reset_index()
        grafico_mapa_salarial = px.choropleth(
            media_salarial_ds,
            locations='iso_alpha',
            color='usd',
        ...
        grafico_mapa_salarial.update_layout(title_x=0.1)
